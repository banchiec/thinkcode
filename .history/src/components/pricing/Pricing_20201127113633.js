...
export default function Pricing() {
    ...
    return (
        <Container fluid className ="container-pricing">
                <h1 className="text-propuesta animate__animated animate__backInLeft">Conoce nuestros servicios</h1>
            <Row>
                ...
                <Col className="container-card">
                    <Card  className=" animete__animated animate__fadeInRight card-pricing" >
