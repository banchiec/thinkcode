                            ...
                            return (
                                ...
                                <Col  md={6} lg={6} >
                                    ...
                                    <div className="content-text-infoSection">
                                        <h2 >{item.firstTitle}<span className="text-title-infoSection animate__animated animate__fadeInLeft animate__delay-1s">{secundTitle}</span></h2>
                                        <p className="text-infoSection">{item.title}</p>
                                    </div>
                                </Col>
                            )
