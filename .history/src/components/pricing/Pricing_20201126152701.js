...
export default function Pricing() {
    return (
        <Container fluid className ="container-pricing">
            <h1 className="text-propuesta">¿Cuéntanos que desarrollo web necesitas?</h1>
            <Row>
                <Col  className="container-card">
                    <Card  className="card-pricing" >
                    <Card.Body>
                        <h2 className="title-card">Desarrollo web</h2>
...
Lista para lograr resultados desde el primer momento
                        </p>
