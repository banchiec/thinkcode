...
import './Pricing.css'
import imagensvg1 from '../../images/imagensvg1.svg'
import imagensvg4 from '../../images/imagensvg4.svg'
import imagen_code_thinking from '../../images/imagen_code_thinking.svg'
            ...
            <Row>
                <Col  className="container-card">
                    ...
                    <Card  className="card-pricing" >
                        <Card.Img variant ="top" src={imagensvg1}></Card.Img>
                        <Card.Body>
                ...
                <Col  className="container-card">
                    ...
                    <Card className="card-pricing">
                        <Card.Img variant ="top" src={imagensvg4}></Card.Img>
                    <Card.Body>
                ...
                <Col className="container-card">
                    <Card  className="card-pricing" >
                        <Card.Img variant ="top" src={imagen_code_thinking}></Card.Img>
                    <Card.Body>
