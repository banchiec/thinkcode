        ...
        <Container fluid className ="container-pricing">
            ...
            <Row>
                <Col  className="container-card">
                    ...
                    <Card  className=" wow animate__animated animate__fadeInLeft card-pricing" data-wow-delay="5" >
                ...
                <Col className="container-card">
                    <Card  className="wow  animate__animated animate__fadeInRight card-pricing" >
