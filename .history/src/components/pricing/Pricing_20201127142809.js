...
export default function Pricing() {
    const classanimation = "card-pricing  animate__animated animate__fadeInLeft "
        ...
        <Container fluid className ="container-pricing">
            ...
            <Row>
                <Col  className="container-card">
                        ...
                        <Card className= { isNaN(controlScroll) ? " card-pricing": "card-pricing  animate__animated animate__fadeInLeft  "} >
