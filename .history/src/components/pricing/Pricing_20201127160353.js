...
export default function Pricing() {
    ...
    const controlScroll = () => {
        ...
        window.onscroll = ()=>{
            ...
            if(window.scrollY > 450 && bandera == true){
                console.log(classtext)
                console.log(window.scrollY)
                setClassText(window.scrollY)
                bandera = false
                // console.log(isNaN(controlScroll()))
            }
        }

    }
    window.addEventListener('scroll',function(){
        let animationCard = this.document.getElementsById('card-pricing')
        // let positionObj1  = animationCard.getBoundingClientRect().top
        ...
        <Container fluid className ="container-pricing">
            ...
            <Row>
                <Col  className="container-card">
                        ...
                        {/* <Card className= { isNaN(controlScroll()) ? "animate__animated animate__fadeInLeft card-pricing": "card-pricing  animate__animated animate__fadeInLeft  "} > */}
                    <Card  className="animate__animated animate__fadeInLeft card-pricing" id="card-pricing" >
